...
from .main_hazard_algorithm import HazardAlgorithm


class HazardProvider(QgsProcessingProvider):
    ...
    def loadAlgorithms(self):
        ...
        """
        self.addAlgorithm(HazardAlgorithm())
    ...
    def name(self):
        ...
        """
        return self.tr('Wildfire Hazard plugin')

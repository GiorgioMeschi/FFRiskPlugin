...
from .rf_forest_fire_risk_algorithm import RiskAlgorithm


class RFForestFireRiskProvider(QgsProcessingProvider):
    ...
    def loadAlgorithms(self):
        ...
        """
        self.addAlgorithm(RiskAlgorithm())
    ...
    def name(self):
        ...
        """
        return self.tr('Wildfire Risk plugin V2')
